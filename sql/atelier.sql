...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 27 mai 2026 à 21:42
...
CREATE TABLE IF NOT EXISTS `absence` (
  ...
  PRIMARY KEY (`datedebut`) USING BTREE,
  KEY `idmotif` (`idmotif`),
...
--
ALTER TABLE `absence`
  ADD CONSTRAINT `absence_ibfk_1` FOREIGN KEY (`idmotif`) REFERENCES `motif` (`idmotif`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `absence_ibfk_2` FOREIGN KEY (`idpersonnel`) REFERENCES `personnel` (`idpersonnel`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `personnel`
--
ALTER TABLE `personnel`
  ADD CONSTRAINT `personnel_ibfk_1` FOREIGN KEY (`idservice`) REFERENCES `service` (`idservice`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
